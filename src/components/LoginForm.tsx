      ...
      <div className="page">
            ...
            <form className="login-form" onSubmit={onSubmit} noValidate>
              ...
              <div className="field">
                <svg className="field-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
                  ...
                  <path d="M4 7L12 13L20 7" stroke="#9CA3AF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
                <input
                  type="email"
                  id="email"
              ...
              <div className="field">
                <svg className="field-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
                  ...
                  <path d="M8 11V7.5C8 5.015 10.015 3 12.5 3S17 5.015 17 7.5V11" stroke="#9CA3AF" strokeWidth="1.8" strokeLinecap="round" />
                ...
                >
                  {showPass ? (
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
                      <path d="M3 3L21 21" stroke="#9CA3AF" strokeWidth="1.8" strokeLinecap="round" />
                      <path d="M10.6 5.63C11.06 5.55 11.53 5.5 12 5.5C18.5 5.5 22 12 22 12C21.4 13.09 20.63 14.15 19.7 15.09M6.6 6.6C4.05 8.15 2 12 2 12C2 12 5.5 18.5 12 18.5C13.68 18.5 15.15 18.06 16.4 17.4" stroke="#9CA3AF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M9.9 9.9C9.34 10.46 9 11.19 9 12C9 13.66 10.34 15 12 15C12.81 15 13.54 14.66 14.1 14.1" stroke="#9CA3AF" strokeWidth="1.8" strokeLinecap="round" />
                    </svg>
                  ) : (
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
                      <path d="M2 12C2 12 5.5 5.5 12 5.5S22 12 22 12 18.5 18.5 12 18.5 2 12 2 12Z" stroke="#9CA3AF" strokeWidth="1.8" strokeLinejoin="round" />
        ...
        <section className="panel panel-hero">
          <div className="theme-toggle">
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
                <circle cx="12" cy="12" r="4.5" stroke={theme === 'light' ? 'white' : '#6B7280'} strokeWidth="1.8" />
                <path d="M12 2.5V4.5M12 19.5V21.5M4.5 12H2.5M21.5 12H19.5M5.6 5.6L4.2 4.2M19.8 19.8L18.4 18.4M18.4 5.6L19.8 4.2M4.2 19.8L5.6 18.4" stroke={theme === 'light' ? 'white' : '#6B7280'} strokeWidth="1.8" strokeLinecap="round" />
              </svg>
            </button>
            <button
              type="button"
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
                <path d="M20 14.5C18.79 15.11 17.43 15.45 16 15.45C11.14 15.45 7.2 11.51 7.2 6.65C7.2 5.22 7.54 3.86 8.15 2.65C4.79 3.98 2.4 7.26 2.4 11.1C2.4 16.13 6.47 20.2 11.5 20.2C15.34 20.2 18.62 17.81 20 14.5Z" stroke={theme === 'dark' ? 'white' : '#6B7280'} strokeWidth="1.8" strokeLinejoin="round" />
              </svg>
            </button>
          </div>
